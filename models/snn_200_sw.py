...
class Model:
    def __init__(self, n_input: int, n_hidden: int, dir_name: str, lr: float, p: float, save_flag=False) -> None:
        app = {}
        ...
        G = generate_small_world(self.n_hid, int(self.n_hid / 2), p)
        ...
        app['S_small_world'].connect(j=j_arr, i=i_arr)
        app['S_small_world'].delay = 'rand()*5*ms'
        app['S_small_world'].w = 'rand()*gmax'
    ...
    def train(self, X, epoch=1, weight_save=False):
        ...
        self.net['S_small_world'].lr = self.learning_rate
    ...
    def evaluate(self, X, chk: str):
        ...
        self.net['S_small_world'].lr = 0  # small-world stdp off
        ...
        features.append(np.array(mon.count, dtype=int32))
